...
//public class FirebaseFoodAdapter extends RecyclerView.Adapter<FirebaseFoodAdapter.FoodItemViewHolder>{
    public class FirebaseFoodAdapter{
...
//            foodLayout = v.findViewById(R.id.rv_order_list);
//            foodName = v.findViewById(R.id.rvtv_order_id);
//            foodPrice = v.findViewById(R.id.rvtv_order_date);
